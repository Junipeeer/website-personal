...
const blogPosts: BlogPost[] = [
  {
    ...
    date: "20 April 2025",
    summary:
      "This blog is currently a work in progress. The first posts will be about this website and a few smaller projects I am working on or planning. For example, I am preparing to work on a half-automated plant management system - beyond just automated watering - and a small, more philosophical exploration of returning to and embracing 'dumb' technology. Currently I am hosting this page as a statically built front-end Vite app, which means that I would have to add blog pages manually, and that is a bit tedious, so I plan to use WordPress or a similar service soon, though I have not decided on anything concrete yet.",
        ...
        <IntroAnimation className="space-y-8">
          ...
          <div className="grid gap-6">
            {blogPosts.map((post, index) => (
              <article
                key={index}
                className="p-4 border-l-2 border-neutral-700 hover:bg-neutral-800/30 transition-colors rounded-r-md mx-2 sm:mx-12"
              >
