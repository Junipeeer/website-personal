      ...
      content: (
        <>
          <p>
            ...
            of my Master's thesis in Media Technologies, my goal was to see how
            a conversational agent could enhance language learning experiences,
            particularly in settings with limited native speaker support.
          </p>
          <p>
            ...
            tool for collecting data on language learning patterns. It uses
            OpenAI's GPT-4 for natural conversation generation, combined with
            Elevenlabs for text-to-speech and Microsoft Azure for speech
            recognition. The project is based on{" "}
            <a
              target="_blank"
      ...
      content: (
        <>
          <p>
            ...
            infrastructure. It integrates wit Babagaboosh, which uses three main
            AI services: OpenAI's GPT-4 for conversation generation, Elevenlabs'
            API for high-quality text-to-speech conversion, and Microsoft
            Azure's speech-to-text services for accurate voice recognition.
          </p>
          <p>
            ...
            designed to be unobtrusive while still providing valuable support
            for language practice. Users can ask it vocabulary or factual
      ...
      content: (
        <>
          <p>
            ...
            acquisition in informal learning environments. The research involved
            ...
            analytics (MMLA), which uses multimodal data analysis to analyse and
          ...
          <p>
            ...
            a greater need for facilitation tools like this bot.
          </p>
        </>
      ),
    },
